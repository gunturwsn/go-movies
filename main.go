...
func main() {
	...
	movies = append(movies, Movie{ID: "1", Isbn: "43822", Title: "Movie 1", Director: &Director{Firstname: "John", Lastname: "Thor"}})
	movies = append(movies, Movie{ID: "2", Isbn: "43823", Title: "Movie 2", Director: &Director{Firstname: "Harry", Lastname: "Keane"}})
